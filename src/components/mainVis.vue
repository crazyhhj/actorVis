<template>
    <div class="tab" id="mainVis" style="width: 100%; height: 100%;">
        ...
        <div id="rhythm-line" style="float: left; width: 79.8%; height: 94.5%; box-shadow: 0 0px  8px rgba(0, 0, 0, 0.2); 
        margin-bottom: 5px;
        margin-right: 5px;
        margin-top: 5px;
        ">
    ...
    methods: {
        ...
        slugRect() {
            ...
            const screen_rect = rect_container.selectAll('.schedulingRect')
                ...
                .attr('width', d => 1.5*widthScale(d.content))
                .attr('height', 4)
                // .attr('x', 0)
                .attr('x', 20)
                .attr('y', (d, r) => 20 + r * 11)
            ...
            svg.append('line')
                .attr('x1', line_Pos.slugRectLine +20)
                .attr('x2', line_Pos.slugRectLine+20)
                .attr('y1', 20)
                .attr('y2', 1500)
                .style("stroke", "black")
